...
from ecommerce.supplier_functions import pull_supplier_orders, check_sup_user_event, product_belong_supplier, add_product
...
def sup_product_data(pid):
    ...
    data = {'forms': sup_forms(), 'product' : Product.query.get(pid),
        'supplier' : Supplier.query.get(session.get('supplier_id')),'categorys': Category.query.all() }
